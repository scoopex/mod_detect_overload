/* 
**  mod_detect_overload.c -- Apache sample detect_overload module
**  [Autogenerated via ``apxs -n detect_overload -g'']
**
**  To play with this sample module first compile it into a
**  DSO file and install it into Apache's modules directory 
**  by running:
**
**    $ apxs -c -i mod_detect_overload.c
**
**  Then activate it in Apache's httpd.conf file for instance
**  for the URL /detect_overload in as follows:
**
**    #   httpd.conf
**    LoadModule detect_overload_module modules/mod_detect_overload.so
**    <Location /detect_overload>
**    SetHandler detect_overload
**    </Location>
**
...
**    $ apachectl restart
**
**  you immediately can request the URL /detect_overload and watch for the
**  output of this module. This can be achieved for instance via:
**
**    $ lynx -mime_header http://localhost/detect_overload 
**
...
**  
**    The sample page from mod_detect_overload.c
*/ 
...
/* http://svn.apache.org/repos/asf/httpd/httpd/branches/2.0.x/modules/generators/mod_status.c */
